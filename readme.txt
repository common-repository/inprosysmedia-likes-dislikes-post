...
1. This screen shot description the buttons positions after the post content corresponds to screenshot-1.(png). Note that the screenshot is stored in the /assets directory.
2. This is the second screen shot description Like button sliding effect in form of thumbs up and increase the counter value after the clicked corresponds to screenshot-2.(png).
3. This is the third screen shot description Dislike button sliding effect in form of thumbs down and increase the counter value  of dislike button and decrease the value in like button if user already liked the post after the clicked corresponds to screenshot-3.(png).
...
1. It stores the values in database.
1. It also show the liked or disliked counts on screen where users can idealize about the popularity of post.
